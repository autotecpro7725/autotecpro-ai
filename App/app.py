...
def inject_base_css():
    st.markdown(
        ...
        /* ============================================================
           MOBILE LIGHT/DAY MODE FIX
           Forces the AutoTecPro dark theme on iPhone/Safari even when
           the phone is using Light appearance.
        ============================================================ */
        ...
        @media (max-width: 768px) {
            ...
            /* Sidebar history rows must stay dark in iPhone light mode */
            section[data-testid="stSidebar"] .stButton > button,
            section[data-testid="stSidebar"] div[data-testid="column"] .stButton > button,
            ...
            /* Keep the two red sidebar action buttons red */
            .sidebar-newcase-btn .stButton > button,
            .sidebar-logout-btn .stButton > button {
                ...
                -webkit-text-fill-color: #ffffff !important;
                border: none !important;
                box-shadow: 0 10px 24px rgba(255, 80, 40, 0.30) !important;
            }
            ...
            /* Inputs, select boxes, text areas and chat input */
            div[data-testid="stTextInputRootElement"],
            ...
            /* Prevent Safari auto-lightening text */
            section[data-testid="stSidebar"] *,
            .chat-bubble *,
            .workspace-card *,
            .assistant-section-card * {
